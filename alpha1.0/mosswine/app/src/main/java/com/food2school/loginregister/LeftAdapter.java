...
public class LeftAdapter extends BaseAdapter{
    ...
    public LeftAdapter(@NonNull Context mContext, @NonNull List<MenuCategory> mData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        MenuCategory model = mData.get(i);
    ...
    public void update(int position,MenuCategory model){
